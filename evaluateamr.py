...
class EvaluateAMR:
    ...
    def evaluate_smatch(self):
        ...
        result = subprocess.Popen('python3 smatch.py --significant 4 -f ../{} ../{}'
            .format(self.name_file_ref, self.name_amr_anon_ref_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['smatch'].append(result.split('\n')[-2])
        
        result = subprocess.Popen('python3 smatch.py --significant 4 -f ../{} ../{}'
            .format(self.name_file_ref, self.name_anon_pred_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['smatch'].append(result.split('\n')[-2])

        result = subprocess.Popen('python3 smatch.py --significant 4 -f ../{} ../{}'
            .format(self.name_amr_anon_ref_full, self.name_anon_pred_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['smatch'].append(result.split('\n')[-2])
    ...
    def evaluate_sema(self):
        ...
        result = subprocess.Popen('python3 sema.py -g ../{} -t ../{}'.format(self.name_file_ref, self.name_amr_anon_ref_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['sema'].append(result)

        result = subprocess.Popen('python3 sema.py -g ../{} -t ../{}'.format(self.name_file_ref, self.name_anon_pred_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['sema'].append(result)
        
        result = subprocess.Popen('python3 sema.py -g ../{} -t ../{}'.format(self.name_amr_anon_ref_full, self.name_anon_pred_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['sema'].append(result)
    ...
    def evaluate_sembleu(self):
        ...
        result = subprocess.Popen('./eval.sh ../{1} ../{0}'.format(self.name_file_ref, self.name_amr_anon_ref_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['sembleu'].append(result.split('\n')[2])

        result = subprocess.Popen('./eval.sh ../{1} ../{0}'.format(self.name_file_ref, self.name_anon_pred_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['sembleu'].append(result.split('\n')[2])

        result = subprocess.Popen('./eval.sh ../{1} ../{0}'.format(self.name_amr_anon_ref_full, self.name_anon_pred_full), 
            shell=True, stdout=subprocess.PIPE).stdout.read()
        self.results['sembleu'].append(result.split('\n')[2])
